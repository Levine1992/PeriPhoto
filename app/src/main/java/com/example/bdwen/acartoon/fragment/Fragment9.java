...
public class Fragment9 extends Fragment implements VI1, View.OnClickListener {
    private static final String TAG = "Fragment1";
    private static Fragment9 fragment1;
    ...
    public static Fragment9 getInstance() {
        if (fragment1 == null) {
