...
public class Fragment6 extends Fragment implements VI1,View.OnClickListener {
    private static final String TAG = "Fragment1";
    private static Fragment6 fragment1;
    ...
    public static Fragment6 getInstance() {
        if (fragment1 == null) {
