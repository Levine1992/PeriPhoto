...
public class Fragment7 extends Fragment implements VI1,View.OnClickListener {
    private static final String TAG = "Fragment1";
    private static Fragment7 fragment1;
    ...
    public static Fragment7 getInstance() {
        if (fragment1 == null) {
